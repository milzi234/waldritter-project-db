...
export interface ApiFooterFooter extends Struct.SingleTypeSchema {
  ...
  attributes: {
    shortDescriptionTitle: Schema.Attribute.String;
    shortDescriptionText: Schema.Attribute.Text;
    links_1: Schema.Attribute.Component<'navigation.link', true>;
    links_2: Schema.Attribute.Component<'navigation.link', true>;
