...
<template>
<h1 class="text-2xl font-display font-bold text-wald-300 mb-6">Neue Kategorie</h1>
<div class="section-panel">
  <form class="space-y-4">
    ...
    <button type="submit" class="btn-cyber" @click.prevent="createCategory">Speichern</button>
  </form>
</div>
</template>
