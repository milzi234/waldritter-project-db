...
k3d-build-images:
    ...
    # Build Content API
    echo "Building Content API..."
    docker build -t k3d-waldritter-registry.localhost:5001/waldritter/content-api:latest ./website-content-api
    ...
    docker build -t k3d-waldritter-registry.localhost:5001/waldritter/website-ui:latest ./website-ui
...
k3d-push-images:
    ...
    docker push k3d-waldritter-registry.localhost:5001/waldritter/content-api:latest
    docker push k3d-waldritter-registry.localhost:5001/waldritter/rails-api:latest
    docker push k3d-waldritter-registry.localhost:5001/waldritter/website-ui:latest
...
k3d-deploy:
    ...
    echo "  - https://waldritter.local (Main website)"
...
k3d-logs service="":
    ...
    if [ -z "{{service}}" ]; then
        ...
        echo "Available services: content-api, rails-api, website-ui, admin-ui"
        exit 1
    fi
